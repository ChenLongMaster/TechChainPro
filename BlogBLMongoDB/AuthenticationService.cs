...
namespace TechchainBL
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public AuthenticationService(IDBClient dbClient, IConfiguration configuration, IUserService userService)
        {
        ...
        public string GenerateJwtToken(User user)
        {
            ...
            {
                var roleName = _roles.Find(x => x.Id == role).FirstOrDefault().Name;
                userClaims.AddClaim(new(ClaimTypes.Role, roleName));
            }
